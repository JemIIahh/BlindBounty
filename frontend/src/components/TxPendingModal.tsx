      ...
      <ModalBody padding="lg">
        <div className="text-center py-4">
          <div className="mx-auto w-16 h-16 rounded-full bg-neutral-800 flex items-center justify-center mb-4">
            <svg className="w-8 h-8 text-em-400 animate-pulse-slow" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <div className="mt-4 flex justify-center">
            <div className="w-6 h-6 border-2 border-neutral-600 border-t-em-400 rounded-full animate-spin" />
          </div>
        </div>
      </ModalBody>
    </Modal>
